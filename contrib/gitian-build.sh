...
VERSION=
commit=false
url=https://github.com/litecoin-project/litecore-litecoin
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the bitcoin, gitian-builder, gitian.sigs.ltc, and litecoin-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/litecoin-project/litecore-litecoin
